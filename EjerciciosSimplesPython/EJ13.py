...
#     - addMatrix(int[][] matrix): suma todos los elementos de la matriz actual a los elementos 
#                                  de [matrix], y el resultado se almacena en la matriz inicial. 
#                                  Si [matrix] no tiene el mismo número de filas y columnas que 
...
#                                   Si [matrix] no tiene el mismo número de filas y columnas que la 
#                                   matriz inicial, la operación no se puede realizar (notificalo).
